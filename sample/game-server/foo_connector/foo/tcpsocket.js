...
var ondata = function(socket, chunk) {
  ...
  if(socket.state === ST_HEAD && socket.packageBuffer === null && !checkMsgId(chunk)) {
...
var checkMsgId = function(data) {
  return true;
  //data === Package.TYPE_HANDSHAKE || data === Package.TYPE_HANDSHAKE_ACK || data === Package.TYPE_HEARTBEAT || data === Package.TYPE_DATA || data === Package.TYPE_KICK;
};
